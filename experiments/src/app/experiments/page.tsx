...
const experiments = [
  ...
  { id: 2, title: "SQL Generation", href: "/experiments/sql-generation" },
  { id: 3, title: "SQL to Visual", href: "/experiments/sql-to-visual" },
];
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 max-w-7xl">
          {experiments.map((experiment) => (
            <div
              key={experiment.id}
              className="border border-gray-300 dark:border-gray-700 rounded-lg p-6 hover:border-gray-400 dark:hover:border-gray-600 transition-colors cursor-pointer"
            >
